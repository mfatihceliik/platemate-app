...
If the task affects backend API shape, server behavior, authentication, database rules, or any cross-stack contract, return to the root `AGENTS.md` first and follow the root full-stack workflow.

For Android-only tasks, continue with this file and `Android/PlateMate/docs/index.md`.
