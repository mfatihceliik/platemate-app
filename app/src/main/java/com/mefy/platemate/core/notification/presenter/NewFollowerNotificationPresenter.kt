...
@Singleton
class NewFollowerNotificationPresenter @Inject constructor(
    ...
    override fun build(notification: AppNotification, contentIntent: PendingIntent): Notification {
        val newFollower = notification as AppNotification.NewFollower
        return buildStandard(newFollower.type, newFollower.title, newFollower.content, contentIntent)
    }
}
