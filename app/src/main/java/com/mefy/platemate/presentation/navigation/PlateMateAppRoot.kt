...
import com.mefy.platemate.presentation.components.PMInAppNotificationBanner
...
fun PlateMateAppRoot(
    ...
    val showBottomBar = currentDestination.isTopLevelStartDestination() && currentTopLevelDestination != null
    ...
    // destination var) yönlendir; böylece cold-start'ta SessionGate çözülene kadar bekler.
