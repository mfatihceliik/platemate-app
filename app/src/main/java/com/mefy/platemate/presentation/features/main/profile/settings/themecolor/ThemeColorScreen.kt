...
fun ThemeColorScreen(
    ...
    PMBaseScreen(
        ...
        LazyColumn(
            ...
            item(key = "preview") {
                ThemeSection(label = stringResource(R.string.profile_theme_preview)) {
                    ThemePreviewCard(modifier = Modifier.fillMaxWidth())
                }
            }

            item(key = "color_grid") {
                ThemeSection(label = stringResource(R.string.profile_theme_accent_color)) {
                    AccentColorGrid(
                        colors = AccentColors,
            ...
            item(key = "appearance") {
                ThemeSection(label = stringResource(R.string.profile_theme_appearance)) {
                    AppearanceSelector(
...
private fun ThemeSection(
    ...
    Column(
        ...
        PMText(text = label, style = PMTextStyle.SectionLabel)
        content()
    }
}
