...
private fun PasswordStrength.toUiModel(): Pair<String, Color> {
    ...
    return when (level) {
        PasswordStrengthLevel.WEAK -> {
            stringResource(R.string.auth_register_password_strength_weak_hint) to colors.primary
        }

        PasswordStrengthLevel.MEDIUM -> {
            stringResource(R.string.auth_register_password_strength_medium) to colors.primary
        }

        PasswordStrengthLevel.STRONG -> {
            stringResource(R.string.auth_register_password_strength_strong) to colors.primary
        }
