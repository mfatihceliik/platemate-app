package com.mefy.platemate.presentation.features.admin.commentreasons.components
...
@Preview(name = "CommentReasonRow Active", showBackground = true, backgroundColor = 0xFFFFFFFF)
@Composable
private fun CommentReasonRowActivePreview() {
    PlateMateTheme(darkTheme = false, dynamicColor = false) {
        CommentReasonRow(
            item = CommentReasonListItem(id = 7L, code = "OTHER", label = "Diğer", requiresDescription = true, active = true),
            onClick = {},
            onToggle = {}
        )
    }
...
@Preview(name = "CommentReasonRow Inactive", showBackground = true, backgroundColor = 0xFF0F172A)
@Composable
private fun CommentReasonRowInactivePreview() {
    PlateMateTheme(darkTheme = true, dynamicColor = false) {
        CommentReasonRow(
            item = CommentReasonListItem(id = 6L, code = "SPAM", label = "Spam", requiresDescription = false, active = false),
            onClick = {},
            onToggle = {}
        )
    }
