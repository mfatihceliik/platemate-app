...
class DiscoverExtensionsTest {
    ...
    fun toSectionTitleResId_returnsExpectedResForAllFilters() {
        ...
        assertEquals(R.string.discover_section_careless_plates, DiscoverFilterUi.Careless.toSectionTitleResId())
    ...
    fun toSectionIcon_returnsExpectedIconForAllFilters() {
        ...
        assertTrue(DiscoverFilterUi.Careless.toSectionIcon() === Icons.Filled.Warning)
